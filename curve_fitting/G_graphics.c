...
/////////////////////////////////////
G_mouse_move_callback mouse_move_callback = NULL;
G_mouse_up_callback   mouse_up_callback = NULL;
G_mouse_down_callback mouse_down_callback = NULL;
...
//////////////////////////////////////////////////////////////
int G_register_mouse_move_handler(G_mouse_move_callback callback) {
	return Register_Mouse_Move(callback);
}

int G_register_mouse_up_handler(G_mouse_up_callback callback) {
	return Register_Mouse_Up(callback);
}

int G_register_mouse_down_handler(G_mouse_down_callback callback) {
	return Register_Mouse_Down(callback);
}
