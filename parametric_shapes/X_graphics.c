...
/////////////////////////////////////
static G_mouse_move_callback mouse_move_callback = NULL;
static G_mouse_up_callback   mouse_up_callback = NULL;
static G_mouse_down_callback mouse_down_callback = NULL;
...
/** Why do we need this?
 if ( !(XPending(TheDisplay)) && !isDragging ) {
   retval = -3000 ;
   goto LLL ;
 }*/
    ...
    case MotionNotify:
      // printf("MotionNotify\n") ;
		...
		// TODO: capture these events somewhere
