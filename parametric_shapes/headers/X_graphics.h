...
/** Callback for mouse movement events. Hack! Should rewrite whole toolkit as event driven.*/
typedef void(*G_mouse_move_callback)(int, int);

/** Callback for mouse down movements*/
typedef void(*G_mouse_down_callback)(int, int);

/** Callback for mouse up event*/
typedef void(*G_mouse_up_callback)(int, double);

int Register_Mouse_Down(G_mouse_down_callback callback);

int Register_Mouse_Up(G_mouse_up_callback callback);

int Register_Mouse_Move(G_mouse_move_callback callback);
